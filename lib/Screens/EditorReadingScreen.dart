...
class EditorReadingScreen extends StatefulWidget {
  ...
  const EditorReadingScreen({super.key ,
    this.MovieID,
    this.sentProjectID,
    this.moviename,
    this.writerId,
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              title: const Text('Uploaded',style: TextStyle(fontFamily: 'BigShotone',fontSize: 20,color: Colors.white,),),
              content: const Row(
                children: [
                        ...
                        child: InkWell(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => const EditorReadingScreen()));
                            },
                            child: const Text(
                              'Read',
                              style: TextStyle(
